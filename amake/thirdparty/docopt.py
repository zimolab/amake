#
# For some reason, docopt cannot be installed using poetry, so I copied the code here.
# The original project is available at https://github.com/docopt/docopt
# The license can be found at licenses/docopt-LICENSE-MIT
#
